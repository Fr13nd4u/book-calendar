    ...
    return (
        <div className="relative mt-16 self-start px-5 h-100 md:hidden">
            <div className="text-white">
                ...
                <span className="flex items-center gap-2 px-3 py-1.5 bg-[#FFFFFF29] rounded-[80px] w-fit">
            ...
            <div className="rounded-full absolute right-0 bottom-[146px] translate-x-full bg-[var(--color-secondary-50)] w-75.25 h-75.25 border-4 border-[var(--color-secondary-100)]">
